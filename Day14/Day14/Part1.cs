...
namespace Day14
{
    internal class Part1
    {
        public static void Run()
        {
            ...
            int[] securityLevels = { 0, 0, 0, 0 };
            int securityLevel = 1;

            string[] robots = puzzle.Split("\r\n");
            ...
            for (int i = 0; i < robots.Length; i++)
            {
                ...
                currentPos[0] = (originalPos[0] + velocity[0] * seconds) % mapSize[0];
                currentPos[1] = (originalPos[1] + velocity[1] * seconds) % mapSize[1];


                for (global::System.Int32 j = 0; j < currentPos.Length; j++)
                {
                    if (currentPos[j] < 0)
                    {
